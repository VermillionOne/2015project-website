    ...
    <div class="container" ng-controller="DashboardController">
      ...
      <div class="dashboard-titles">
        ...
        <div class="row">
          ...
          {{-- Edit schedule header and route back to tickets index --}}
          <div class="col-md-8 col-sm-6 col-xs-12">

            <h2 class="results-title-txt">Edit Schedule</h2>
          ...
          <div class="col-md-4 col-sm-6 hidden-xs">
            ...
            <a href="{{ route('schedules.index', ['id' => $event['id']]) }}" class="clear-form search-clear">Back To Schedules</a>
          ...
          <div class="schedule-card">
            ...
            <div class = "event-detail-tickets-col padding-ticket">
              <div class="row">
                ...
                {!! ViewHelper::formOpen(['route' => ['schedules.update', 'event' => $event['id'], 'id' => $eventSchedule], 'ng-click' => 'schedule.updateJson()', 'method' => 'PUT']) !!}
                  ...
                  <div class = "col-sm-12">
                    ...
                    <div class="form-group col-sm-5 col-sm-offset-1">
                      ...
                      <div class="inner-addon right-addon input-group-lg create-event-detail-date-picker">
                        ...
                        {!! Form::text('startDate', null, ['class' => 'form-control date-pick datepicker', 'placeholder' => 'MM/DD/YYY', 'data-role' => 'date-picker', 'ng-model' => 'event.startDate', 'id' => 'txtFromDate', 'data-date-format' => 'mm/dd/yyyy', 'required' => 'required']) !!}
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-sm-6 create-event-time-input">
                          ...
                          {!! Form::select('startTime', $timeList, $startTime, ['class' => 'form-control', 'required' => 'required']) !!}
                        ...
                        <div class="col-sm-6 create-event-time-button">
                          ...
                          <span class="btn btn-suaray btn-suaray-primary control-label" ng-click="startAmPm = 'am'">
                            {!! Form::radio('startMeridian', 'am', null, ['class' => 'form-control', 'ng-model' => 'event.startMeridian', 'required' => 'required', 'ng-init' => 'event.startMeridian=true']) !!}
                          AM </span>
                    ...
                    <div class="form-group col-sm-5">{{-- END DATE Tag --}}
                      ...
                      <div class="inner-addon right-addon input-group-lg create-event-detail-date-picker">
                        ...
                        {!! Form::text('endDate', null, ['class' => 'form-control datepicker date-pick', 'data-role' => 'date-picker', 'placeholder' => 'MM/DD/YYY', 'ng-model' => 'event.endDate', 'id' => 'txtToDate', 'data-date-format' => 'mm/dd/yyyy', 'required' => 'required']) !!}
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-sm-6 create-event-time-input">
                          ...
                          <div class="inner-addon right-addon input-group-lg create-event-detail-time-picker">
                            <i class="glyphicon create-event-detail glyphicon-time"></i>
                              {!! Form::select('endTime', $timeList, $endTime, ['class' => 'form-control', 'required' => 'required']) !!}
                    ...
                    {{-- User to choose timezone for event --}}
                    <div class="form-group col-sm-10 col-sm-offset-1">
                      {!! Form::label('timeZoneId', 'Time Zone', ['class' => 'clearfix control-label']) !!}

                      {!! Form::select('timeZoneId', $timezoneList, $timeZonePrevious, ['class' => 'form-control', 'placeholder' => 'Select Time Zone', 'required']) !!}
                    </div>
                    ...
                    {{-- Submit for creating new schedule --}}
                    <div class="row">
                      <div class="form-group text-right">

                        {{-- Adds new dates for specific event --}}
                        <div class="col-sm-3 col-sm-offset-8">
                          <button class="btn btn-suaray btn-sm btn-block btn-suaray-positive pull-right" type="submit" name="update">Update</button>
                        </div>
